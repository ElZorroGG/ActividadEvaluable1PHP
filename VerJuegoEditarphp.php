...
// Comprobar que el juego existe y pertenece al usuario
try {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($titulo === '') {
        ...
        header('Location: VerJuegoEditar.php?id=' . $id);
        exit;
    }
    ...
    try {
        ...
        header('Location: VerJuego.php?id=' . $id);
        exit;
    } catch (Exception $e) {
